...
type VistorsApp struct {
	...
	Spec   VistorsAppSpec   `json:"spec,omitempty"`
	Status VistorsAppStatus `json:"status,omitempty"`
}
...
type VistorsAppList struct {
	...
	Items           []VistorsApp `json:"items"`
}

func init() {
	SchemeBuilder.Register(&VistorsApp{}, &VistorsAppList{})
}
